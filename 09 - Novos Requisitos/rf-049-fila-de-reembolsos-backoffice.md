...
**Descrição:** Módulo do Backoffice para triagem e processamento manual de solicitações de reembolso que ultrapassaram o prazo de 7 dias para reembolso automático (RF-040). O Administrador visualiza a fila de solicitações pendentes, analisa os detalhes de cada caso, e aprova (com valor integral ou parcial) ou rejeita (com motivo obrigatório) cada solicitação.
...
| ID        | Requisito                                                                                                                                                       |
|-----------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------|
| RF-049.12 | A tabela deve exibir as colunas: Checkbox, ID Reembolso, ID Pedido, Turista (nome + e-mail), Atração, Valor (R$), Motivo, Data Compra, Data Solicitação, SLA, Status |
...
| RN-049.02 | Somente solicitações manuais com mais de 7 dias desde a compra aparecem na fila; reembolsos automáticos (≤ 7 dias) são processados pelo RF-040 sem passar pela fila          |
...
| CA-049.06 | Clicar em uma linha da tabela                                                      | Modal de Detalhes e Decisão abre exibindo todas as seções: Dados da Solicitação, Ingresso, Motivo e Decisão |
