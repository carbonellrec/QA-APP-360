...
| RF-057.16 | Na aba "Pendente de Aprovação", a barra de ações deve exibir: "Aprovar selecionados", "Rejeitar selecionados"                         |
...
| Pendente de Aprovação  | Parceiros aguardando aprovação administrativa | Aprovar, Rejeitar                                              |
...
| Pendente de Aprovação | [Selecionados X] [Aprovar selecionados] [Rejeitar selecionados]                                   |
...
| RN-057.15 | O Parceiro Comercial aprovado recebe acesso imediato ao Backoffice, mas suas atrações **não podem operar comercialmente** (não permitem venda de ingressos) enquanto o Contrato de Atração correspondente não atingir o status "Ativo" no módulo RF-008, ou seja, enquanto todas as assinaturas via DocuSign não forem coletadas.                                     |
...
| CA-057.05 | Navegar para a aba "Pendente de Aprovação"                           | Lista atualiza exibindo apenas parceiros com status Pendente; barra de ações exibe Aprovar e Rejeitar                                                          |
...
| CA-057.09 | Aprovar parceiro pendente                                            | Status alterado para "Ativa"; parceiro migra para aba "Ativas"; e-mail com credenciais enviado; Contrato de Atração com status "Rascunho" gerado em RF-008    |
...
| CA-057.16 | Excluir parceiro com confirmação                                     | Parceiro removido de todas as abas; mensagem de sucesso exibida                                                                                                |
