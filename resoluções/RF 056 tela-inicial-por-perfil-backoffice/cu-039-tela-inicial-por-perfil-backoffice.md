...
Pós-condições: Usuário direcionado à tela inicial correta do seu perfil; menu lateral exibe somente os módulos permitidos; estado de navegação mantido durante a sessão; preferência de exibição do menu (recolhido/expandido) persistida entre sessões (RN-056.11)
...
6. Quando o Parceiro Comercial possuir mais de uma atração vinculada, o sistema exibe o seletor de atração no topo e, ao trocar a atração, todos os KPIs, tabelas e gráficos da tela são atualizados; quando possuir apenas uma atração vinculada, o seletor não é exibido (RN-056.12).
...
3c. Editor ou Leitor sem atração vinculada: Sistema exibe mensagem informativa e bloqueia acesso aos módulos dependentes de atração.
